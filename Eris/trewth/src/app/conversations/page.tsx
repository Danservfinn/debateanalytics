...
const mockConversations: Conversation[] = [
  {
    ...
    claim: "Carbon taxes are the most effective way to reduce emissions",
    participants: 234,
    messages: 1523,
  ...
  },
  {
    ...
    claim: "AGI poses an existential risk within the next decade",
    participants: 189,
    messages: 987,
  ...
  },
  {
    ...
    claim: "UBI would eliminate poverty without reducing workforce participation",
    participants: 312,
    messages: 2104,
          ...
          <Card className="border-dashed">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                Start your first critical conversation and debate with truth-scored arguments
              </p>
              <Link href="/conversations/new">
